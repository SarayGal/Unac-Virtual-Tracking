    ...
    <div className="inicio">
      <div class="container-contact100">
        <div class="wrap-contact100">
          <form
            class="contact100-form validate-form position-absolute"
            action="main.php"
            method="post"
          >
            ...
            >
              <span class="label-input100" for="celular">
                Celular
              </span>
              <input
                class="input100"
            ...
            >
              <span class="label-input100" for="contraseña">
        ...
        <div class="wrap-contact100">
          ...
          >
            ...
            >
              <span class="label-input100" for="cedula">
            ...
            >
              <span class="label-input100" for="código">
                Código Estudiantil
              </span>
              <input
                class="input100"
            ...
            <div class="wrap-input100 input100-select">
              ...
              <div>
                <select
                  ...
                  id="grado"
                  required="true"
                  data-validate="El grado es requerido"
                >
                  <option disabled selected>
                    Selecciona tu grado
                  </option>
